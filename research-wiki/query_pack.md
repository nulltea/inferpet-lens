...
## Key Papers (33 total)
- [paper:arefeen2023_metamorphosis_taskoriented_privacy] MetaMorphosis: Task-oriented Privacy Cognizant Feature Generation for Multi-task Learning
- [paper:asoodeh2015_maximal_correlation_mutual] On Maximal Correlation, Mutual Information and Data Privacy
...
## Recent Relationships (97 total)
  claim:gelo-orthogonal-gram-leak-rowmix-defeats-bss --extends--> claim:kv-cloak-channel-decoupling-feature-mix-loadbearing
  exp:b-r4-split --supports--> claim:pripert-spectral-converse-slack-comonotone-tracking
  exp:embed-sgt-channel-mi-shape-blindness --supports--> claim:sgt-channel-mi-shape-blind-metric-bound-vec2text
  claim:cross-surface-matched-probe-tracks-recovery --generalizes--> claim:pripert-spectral-converse-slack-comonotone-tracking
  claim:cross-surface-matched-probe-tracks-recovery --generalizes--> claim:depth-inversion-certificate
  claim:cross-surface-matched-probe-tracks-recovery --generalizes--> claim:perm-llr-threshold
  claim:cross-surface-matched-probe-tracks-recovery --generalizes--> claim:spectral-channel-mi-embedding-inversion
  claim:probe-failure-dichotomy-matched-or-vacuous --generalizes--> claim:gelo-orthogonal-gram-leak-rowmix-defeats-bss
  claim:probe-fai
